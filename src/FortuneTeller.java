...
public class FortuneTeller extends JPanel implements Runnable, MouseListener {
    ...
    static void begin() {
    	...
    	JOptionPane.showMessageDialog(null, "Welcome User. Stare into the eyes of the abyss and ask thy question.");
    ...
    public void mousePressed(MouseEvent e) {
   	 ...
   	 if (areClose(mouseX, secretLocationX) && areClose(mouseY, secretLocationY)) {
   		 ...
   		 JOptionPane.showInputDialog("Ask your question for thine fortune teller.");
